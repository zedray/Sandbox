...
public final class MinimumNumberOfCoins {
    ...
    public static void main(final String[] args) {
        ...
        // Problem
    	final int[] coins = new int[]{2, 4, 8};
    	final int sum = 11;
    	
        // Solution
        System.out.println("Number of coins " + getNumberOfCoins(coins, sum) + " required for sum of " + sum);
    }
    	...
    	for (int i = 0; i < min.length; i++) {
    	    ...
    	    for (int j = 0; j < coins.length; j++) {
    	        if (
    	                /**
    	                 * --Coin is valid--
    	                 * Coin value is less than or equal to the current sum.
    	                 */
    	                coins[j] <= i
    	                /**
    	                 * --Coin can be added to get this value--
    	                 * Add this coin to historical min value to get target
    	                 * "i" value.  Accept if less than min[i].
    	                 */
